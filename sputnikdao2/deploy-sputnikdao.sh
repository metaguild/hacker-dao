...
near deploy --wasmFile=res/sputnikdao2.wasm --initFunction "new" --initArgs "{\"config\": {\"name\": \"hack\", \"purpose\": \"Hackathon DAO\", \"metadata\":\"\"}, \"policy\": $POLICY" --accountId $CONTRACT_ACC
